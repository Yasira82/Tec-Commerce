...
export default function TermsPage() {
  return (
    <main style={wrap}>
      ...
      <p>{APP} is a Pi-native merchant commerce application for managing products, orders, and revenue, with payments in Pi. We may add, change, or discontinue features at any time.</p>
